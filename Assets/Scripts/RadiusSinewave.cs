...
public class RadiusSinewave : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Ajustar parámetros basados en la rotación
        amplitude = Mathf.Abs(rotation) * 2; // Escala de 0 a 2
        frequency = Mathf.Abs(rotation) * 2; // Escala de 0 a 2
        movementSpeed = Mathf.Abs(rotation) * 2; // Escala de 0 a 2
